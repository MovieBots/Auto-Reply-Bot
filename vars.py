...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001619702173 -1002686704351 -1002216169351 -1002593532701').split() if re.match(r'^-?\d+$', channel_id)]
