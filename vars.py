...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1002162221322 -1002524472780 -1001758595569 -1001882489020 -1001379644082').split() if re.match(r'^-?\d+$', channel_id)]
