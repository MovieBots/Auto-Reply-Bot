...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1002455191730 -1001824489823 100182448982 -1001576323967').split() if re.match(r'^-?\d+$', channel_id)]
