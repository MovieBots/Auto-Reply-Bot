...
FROM_GRP = [int(channel_id) for channel_id in environ.get('FROM_GRP', '-1001699354905 -1001629066592 -1002686704351 -1002216169351 -1002455191730').split() if re.match(r'^-?\d+$', channel_id)]
